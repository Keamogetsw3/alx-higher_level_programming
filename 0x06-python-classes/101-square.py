#!/usr/bin/python3
""" This module defines a class that represents a square, with attributes for size and position. It provides methods for calculating the area of the square and printing it on the screen """
